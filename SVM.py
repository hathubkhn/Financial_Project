...
train_input = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Train\\LG화학.csv",
                          usecols=[1, 2, 3, 4, 5])
train_input = np.array(train_input)
train_output = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Train\\LG화학.csv",
                           usecols=[6])
train_output = np.array(train_output)
train_output.ravel()

val_input = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Val\\LG화학.csv",
                        usecols=[1, 2, 3, 4, 5])
val_input = np.array(val_input)
val_output = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Val\\LG화학.csv",
                         usecols=[6])
val_output = np.array(val_output)
val_output.ravel()

test_input = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Test\\LG화학.csv",
                         usecols=[1, 2, 3, 4, 5])
test_input = np.array(test_input)
test_output = pd.read_csv("D:\\Lab\\Stock\\File\\Study1\\KOSPI200\\Baseline_data\\Test\\LG화학.csv",
                          usecols=[6])
...
with  open('D:\\Lab\\Financial project\\Baseline\\Results\\Study1\\KOSPI200\\Com_5.txt', 'w') as f:
    if _chosen_kernel[0]:
